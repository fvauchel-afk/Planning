...
import { categoriesDemandeCourantes, demandeEstOuverte, demandePeutEtreSupprimee, isReunionDirectionDemande } from "@/lib/demandes";
import {
...
export function DemandesPage() {
  const { snapshot, loading, updateDemande, deleteDemande } = usePlanning();
  ...
  const categoryTabs = useMemo(() => categoriesDemandeCourantes(), []);
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-stone-600">
            {archives
              ...
              : "Congés, suggestions et le reste. Les commandes atelier sont dans l’onglet Commande."}
          </p>
        </div>
        <button
          type="button"
